...
A Redpanda source connector is represented by a single consumer in a Kafka consumer group. By virtue of that, a source's
...
| `clientID`           | A Kafka client ID.                                                                                                                                                                                           | false    | `conduit-connector-redpanda` |
