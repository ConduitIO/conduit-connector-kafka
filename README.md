...
| `topics`             | Topics is a comma separated list of topics from which records will be read, ex: "topic1,topic2".                                                                                                       | true     |                           |
| ~~`topic`~~          | Topic is the topic to read from. **Deprecated: use `topics` instead.**                                                                                                                                 | false    |                           |
| `clientID`           | A client ID.                                                                                                                                                                                           | false    | `conduit-connector-redpanda` |
...
| `clientCert`         | A certificate for the client, in PEM format. If provided, the private key needs to be provided too.                                                                                                    | false    |                           |
| `clientKey`          | A private key for the client, in PEM format. If provided, the certificate needs to be provided too.                                                                                                    | false    |                           |
| `caCert`             | The broker's certificate, in PEM format.                                                                                                                                                               | false    |                           |
